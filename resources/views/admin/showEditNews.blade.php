            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title mt-5">Sửa tin tức</h3>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <form action={{ route('editNews.store', ["id" => $news->id]) }} enctype="multipart/form-data" method="POST">
                            @csrf
                            @method('PUT')
