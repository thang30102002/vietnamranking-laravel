        ...
        <div class="block mt-4 relative">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox"
                    ...
                    name="remember">
                <span class="ms-2 text-sm text-white">{{ __('Ghi nhớ ') }}</span>
            </label>
            <a class=" absolute right-0 ms-2 text-sm text-white" href="/register">Bạn chưa có tài khoản?</a>
        </div>
