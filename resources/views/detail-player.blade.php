...
<body class="w3-light-grey"
    ...
    <x-menu />
    <!-- Page Container -->
    <div class="w3-content w3-margin-top text-center" style="max-width:1400px;">
        ...
        <div class="w3-row-padding">
            ...
            <div class="w3-third">
                ...
                <div class="w3-white w3-text-grey w3-card-4">
                    ...
                    <div class="w3-containerm text-left p-[10px]">
                        ...
                        <p class=" text-left">Ngày tham gia: {{ $player->created_at }}
                        </p>
                        <hr>

                        <p class="w3-large"><b><i class="fa fa-asterisk fa-fw w3-margin-right icon"></i>Kỹ năng</b></p>
                        <p>Độ chính xác</p>
            ...
            <div class="w3-twothird">
                ...
                <div class="w3-container w3-card w3-white w3-margin-bottom text-left">
                    <h2 class="w3-text-grey py-[10px] flex items-center"><i class="fa fa-trophy"
