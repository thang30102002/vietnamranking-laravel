        ...
        <div class="modal-dialog h-full content-center w-[302px] sm:w-full m-auto">
            <div class="modal-content">
                ...
                <div class="modal-body max-h-[500px] overflow-y-auto text-[13px] sm:text-[18px]">
                    <ul>
                        <li class=" text-justify">Khi người chơi tham gia các giải đấu trong hệ thống của VietNamPool hồ
                            sơ thông tin và giải thưởng của người chơi sẽ được lưu công khai.</li><br />
