...
<a class=" min-h-[77px] max-h-[150px]" style="text-decoration:none;color:#21324C"
    href="{{ route('ranking.detail', ['id' => $player->user->id]) }}">
    <div
        ...
        <div
            ...
            <span
                class="name-player flex items-center text-[#21324C] text-[0.7rem] sm:text-[1.5rem] 2xl:text-[2rem]">{{ $player->name }}-{{ $player->player_ranking->ranking->name }}</span>
            <div
                class=" grid md:text-right text-left text-[0.7rem] sm:text-[1.5rem] md:items-center 2xl:absolute 2xl:top-0 2xl:bottom-0 2xl:right-2">
